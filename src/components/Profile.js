      ...
      <div className="d-block">
         <div class="clearfix">
            <div class="float-left">
               <Typography  className="pseudo_border1" variant="h4" style={{ fontSize:25, marginTop: 50, marginBottom: 30, fontWeight:500 }}>
               Profile
               </Typography>
            </div>
            <div class="float-right">
               <Typography variant="h4" style={{ fontSize:25, marginTop: 50, marginBottom: 30, fontWeight:500 }}>
         ...
         <div class="row">
            ...
            <div class="col-12 col-md-8 d-flex flex-column align-items-center align-items-md-start justify-content-center justify-content-md-start">
               <div className="d-flex justify-content-center justify-content-md-start flex-column mt-4 mt-md-0 mb-4">
                  ...
                  <Typography style={{ fontSize: 16, marginBottom: 1 }} variant="p"> 
               ...
               <div className="d-flex justify-content-center justify-content-md-start flex-column mb-4">
                  ...
                  <Typography style={{ fontSize: 16, marginBottom: 1 }} variant="p">email@address.com
                  {/* {admin?.email} */}
                  </Typography>
               </div>
            </div>
