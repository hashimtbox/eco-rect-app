                  ...
                  return (
                    <div key={item.id}>
                      <div style={{ display: "flex", paddingTop: 20, paddingBottom: 20 }}>
                        <div className="img-border-cart"><img src={item.image || macbook} alt={macbook} height="150" width="150" /></div>
                        <div className="sprd-basket-item__info" style={{ marginLeft: 20 }}>
                          ...
                          <div className="sprd-basket-item__info__col">
                            ...
                            <div className="sprd-quantity-control sprd-bg-m3 sprd-lbc-s2">
                              <button className="sprd-quantity-control__button" type="button"><RemoveIcon /></button>
                              <input type="number" className="sprd-quantity-control__input" max="any" min="1" value="1" />
                              <button className="sprd-quantity-control__button" type="button"><AddIcon /></button>
                            </div>
            ...
            <Grid item xl={5} lg={5} md={12} sm={12} xs={12} >
              ...
              <div className="checkout-border-cart">
                <div style={{ display: "flex", marginBottom: 10 }}>
                  <Typography style={{ color: "black", fontSize: 16, margin: 0 }} variant={"h6"}>
                    Subtotal:
                      </Typography>
                  <Typography style={{ color: "black", marginLeft: "auto", fontWeight: 400, fontSize: 15 }} variant={"h6"}>
                    $71.98
                      </Typography>
                </div>
                <div style={{ display: "flex", marginBottom: 10 }}>
                ...
                <div style={{ display: "flex", marginBottom: 10 }}>
                  <div>
                    ...
                    <Typography style={{ color: "black", fontWeight: 400, fontSize: 16, margin: 0, marginTop: -6 }} variant={"h6"}>
                      15% Off Everything
                      </Typography>
                  </div>
                  <Typography className="redeem-background" style={{ marginTop: 14, marginLeft: "auto", fontWeight: 400, fontSize: 15 }} variant={"h6"}>
                    Redeem
                      </Typography>
                </div>
