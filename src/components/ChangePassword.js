...
import authSlice, {changePassword, signin} from "../store/auth";
        ...
        <Container component="main" maxWidth="sm">
          ...
          <div>
            ...
            >
              <Typography
                variant="h4"
                style={{ marginTop: 50, marginBottom: 30, fontWeight: 500 }}
              >
                Change Password
              </Typography>
            </div>
            ...
            <Formik
              ...
              onSubmit={(values) => {
                console.log(values);
                dispatch(changePassword(user?.email, values.oldpassword , values.newpassword))
                if (error) {
                    handleClickSnackbar();
                }
              }}
